...
namespace HotBag.Services.MongoProviders
{
    ...
    public class TMTestService : IMTestService, ITransientDependencies
    {
        private readonly IMongoRepository<MTestEntity, Guid> _repository;
        //private readonly IUnitOfWork _unitOfWork;
        private readonly IObjectMapper _objectMapper;
        public TMTestService(IMongoRepository<MTestEntity, Guid> repository, IObjectMapper objectMapper)
        {
